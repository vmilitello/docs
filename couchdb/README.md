...
```console
$ docker run -d --name my-couchdb arm64v8/couchdb
```
...
```console
$ docker run --name my-couchdb-app --link my-couchdb:couch arm64v8/couchdb
```
...
```console
$ docker run -d -v $(pwd):/usr/local/var/lib/couchdb --name my-couchdb arm64v8/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/usr/local/etc/couchdb/local.d -d arm64v8/couchdb
```

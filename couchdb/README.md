...
```console
$ docker run -d --name my-couchdb i386/couchdb
```
...
```console
$ docker run --name my-couchdb-app --link my-couchdb:couch i386/couchdb
```
...
```console
$ docker run -d -v $(pwd):/usr/local/var/lib/couchdb --name my-couchdb i386/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/usr/local/etc/couchdb/local.d -d i386/couchdb
```

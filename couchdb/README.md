...
```console
$ docker run -d --name my-couchdb winamd64/couchdb
```
...
```console
$ docker run --name my-couchdb-app --link my-couchdb:couch winamd64/couchdb
```
...
```console
$ docker run -d -v $(pwd):/usr/local/var/lib/couchdb --name my-couchdb winamd64/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/usr/local/etc/couchdb/local.d -d winamd64/couchdb
```

...
```console
$ docker run -d --name my-couchdb ppc64le/couchdb
```
...
```console
$ docker run --name my-couchdb-app --link my-couchdb:couch ppc64le/couchdb
```
...
```console
$ docker run -d -v $(pwd):/usr/local/var/lib/couchdb --name my-couchdb ppc64le/couchdb
```
...
```console
$ docker run --name my-couchdb -v /my/custom-config-dir:/usr/local/etc/couchdb/local.d -d ppc64le/couchdb
```

...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/docker/badge/icon) (`winamd64/docker` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/windows-amd64/job/docker/)
...
## `winamd64/docker:windowsservercore`

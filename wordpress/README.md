...
-	[`4.9.0-apache`, `4.9-apache`, `4-apache`, `apache`, `4.9.0`, `4.9`, `4`, `latest`, `4.9.0-php5.6-apache`, `4.9-php5.6-apache`, `4-php5.6-apache`, `php5.6-apache`, `4.9.0-php5.6`, `4.9-php5.6`, `4-php5.6`, `php5.6` (*php5.6/apache/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php5.6/apache/Dockerfile)
-	[`4.9.0-fpm`, `4.9-fpm`, `4-fpm`, `fpm`, `4.9.0-php5.6-fpm`, `4.9-php5.6-fpm`, `4-php5.6-fpm`, `php5.6-fpm` (*php5.6/fpm/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php5.6/fpm/Dockerfile)
-	[`4.9.0-fpm-alpine`, `4.9-fpm-alpine`, `4-fpm-alpine`, `fpm-alpine`, `4.9.0-php5.6-fpm-alpine`, `4.9-php5.6-fpm-alpine`, `4-php5.6-fpm-alpine`, `php5.6-fpm-alpine` (*php5.6/fpm-alpine/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php5.6/fpm-alpine/Dockerfile)
-	[`4.9.0-php7.0-apache`, `4.9-php7.0-apache`, `4-php7.0-apache`, `php7.0-apache`, `4.9.0-php7.0`, `4.9-php7.0`, `4-php7.0`, `php7.0` (*php7.0/apache/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php7.0/apache/Dockerfile)
-	[`4.9.0-php7.0-fpm`, `4.9-php7.0-fpm`, `4-php7.0-fpm`, `php7.0-fpm` (*php7.0/fpm/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php7.0/fpm/Dockerfile)
-	[`4.9.0-php7.0-fpm-alpine`, `4.9-php7.0-fpm-alpine`, `4-php7.0-fpm-alpine`, `php7.0-fpm-alpine` (*php7.0/fpm-alpine/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php7.0/fpm-alpine/Dockerfile)
-	[`4.9.0-php7.1-apache`, `4.9-php7.1-apache`, `4-php7.1-apache`, `php7.1-apache`, `4.9.0-php7.1`, `4.9-php7.1`, `4-php7.1`, `php7.1` (*php7.1/apache/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php7.1/apache/Dockerfile)
-	[`4.9.0-php7.1-fpm`, `4.9-php7.1-fpm`, `4-php7.1-fpm`, `php7.1-fpm` (*php7.1/fpm/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php7.1/fpm/Dockerfile)
-	[`4.9.0-php7.1-fpm-alpine`, `4.9-php7.1-fpm-alpine`, `4-php7.1-fpm-alpine`, `php7.1-fpm-alpine` (*php7.1/fpm-alpine/Dockerfile*)](https://github.com/docker-library/wordpress/blob/050652ba972ba46d24cb1b2174a2c4c9fbbbcd80/php7.1/fpm-alpine/Dockerfile)
-	[`cli-1.4.1`, `cli-1.4`, `cli-1`, `cli`, `cli-1.4.1-php5.6`, `cli-1.4-php5.6`, `cli-1-php5.6`, `cli-php5.6` (*php5.6/cli/Dockerfile*)](https://github.com/docker-library/wordpress/blob/e3c8cccbe1bec9e59fc82f7e743e4c1665a9e22d/php5.6/cli/Dockerfile)
